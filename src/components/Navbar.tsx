  ...
  return (
    <nav className="flex items-center justify-between px-8 py-4 border-b border-slate-800">
      ...
      <div className="hidden md:flex items-center gap-8 font-medium">
        <Link
          ...
          className={`hover:text-accent transition-colors ${
            isWorkoutActive ? "text-accent" : "text-slate-300"
          }`}
        >
          Workout
        </Link>
      ...
      <div className="flex items-center gap-4">
        <Link
          href="/my-plan"
          className="flex items-center gap-2 border border-slate-700 rounded-full px-4 py-1.5 text-sm hover:border-slate-500 transition-colors"
        >
          <span>Saved</span>
        ...
        <Link
          href="/my-plan"
          className="flex items-center gap-2 bg-accent text-slate-950 font-medium rounded-full px-4 py-1.5 text-sm hover:bg-accent/90 transition-colors"
        >
          <span>Plan</span>
